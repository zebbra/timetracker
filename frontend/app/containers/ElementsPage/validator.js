import { alphaNumericExtendedString, dateBeforeAndAfter, twoDecimalsNumber, required } from 'utils/generic-validators';
...
function validate(values) {
  ...
  Object.assign(errors, alphaNumericExtendedString(values, 'label', 3, 100));
